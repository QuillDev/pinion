 ...
 * 02111-1307 USA
 */
package moe.quill.pinion.toast.packets;
...
public class AutoWrapper<T> implements EquivalentConverter<T> {
    private static HashMap<Class<?>, Object> sinning = new HashMap<>() {{
        put(int.class, 0);
        put(short.class, 0);
        put(float.class, 0);
        put(long.class, 0);
    ...
    public T wrap(Object nmsObject) {
        ...
        try {
            instance = wrapperClass.getConstructor().newInstance();
    ...
    public Object unwrap(Object wrapper) {
        ...
        try {
            ...
            try {
                ...
                constructor = nmsClass.getDeclaredConstructors()[0];
            }
            constructor.trySetAccessible();

            final var ctorParams = constructor.getParameters();
            final var argList = new Object[ctorParams.length];
            ...
            for (int i = 0; i < ctorParams.length; i++) {
                ...
                argList[i] = sinning.get(ctorParams[i].getType());
            }
            instance = constructor.newInstance(argList);
...
//
//        final var getDeclaredFields0 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
//        getDeclaredFields0.setAccessible(true);
//        final var fields = (Field[]) getDeclaredFields0.invoke(Field.class, false);
...
//        final var modifiers = Field.class.getDeclaredField("modifiers");
