...
public class WrapperPlayServerAdvancements extends AbstractPacket {
    ...
    private static final AutoWrapper<AdvancementDisplay> DISPLAY = AutoWrapper
            .wrap(AdvancementDisplay.class, "advancements.AdvancementDisplay")
            ...
            .field(4, EnumWrappers.getGenericConverter(getMinecraftClass("advancements.AdvancementFrameType"), FrameType.class));

    private static final AutoWrapper<SerializedAdvancement> WRAPPER = AutoWrapper
            .wrap(SerializedAdvancement.class, "advancements.Advancement$SerializedAdvancement")
